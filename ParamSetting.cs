...
namespace UHFReader288Demo
{
    public partial class ParamSetting : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (fCmdRet==0)
            {
                StatusBar1.Panels[0].Text = DateTime.Now.ToLongTimeString() + " 设置成功";
            }
            else
            {
                StatusBar1.Panels[0].Text = DateTime.Now.ToLongTimeString() + " 设置失败";
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (fCmdRet == 0)
            {
                ...
                StatusBar1.Panels[0].Text = DateTime.Now.ToLongTimeString() + " 读取成功";
            }
            else
            {
                StatusBar1.Panels[0].Text = DateTime.Now.ToLongTimeString() + " 读取失败";
            }
        }
